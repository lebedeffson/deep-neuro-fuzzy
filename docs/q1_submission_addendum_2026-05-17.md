...
| dataset | budget | n_seeds | status_note |
|---|---:|---:|---|
| susy_binary_200000 | 400 | 3 | preliminary (not used for main claims) |
...
1. RuleFit on SUSY uses complete evidence at B=100 and B=200 (6 seeds each).
2. SUSY B=400 is marked preliminary and excluded from the main comparative table until completion.
