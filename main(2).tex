...
\begin{table}[H]
\centering
\caption{Reference neuro-fuzzy architectures and Routed KAFN against the best external baseline per data set (signed delta; positive is better). Dashes indicate that Routed KAFN was evaluated only in the focused Covtype block.}
...
covtype\_binary\_20000 & F1   & extra trees classifier           & -0.1444 & -0.0417 & -0.0428 & -0.1027 & -0.0372 \\
\bottomrule
\end{tabular}
\end{table}
